        ...
        <div className="services section_padding">
            <div className='service-sec'>
                <h1 className='service-header'>
                    How Builders Workflow helps with
...
export const Solution = () => {
    return (
        <div className='solution section_padding'>
            ...
            <p>Different teams managing construction projects can use Builders Workflow in many ways and on any device - whether smart phone, tablet, or laptop</p>
